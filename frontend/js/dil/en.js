export default {
  ...
  bakiye: { alacakli: 'creditor', borclu: 'debtor', esit: 'even' },
  ortak: {
    baslik: 'Partners',
    ekleBtn: '+ Add Partner',
  ...
  borc: { baslik: 'Suggested Transfers' },
  islem: {
    baslik: 'Transactions',
  ...
  rol: { yonetici: 'Admin', uye: 'Member', izleyici: 'Viewer' },
  rolAciklama: {
    uye: 'Member (can add expenses)',
    izleyici: 'Viewer (read only)',
    yonetici: 'Admin (full access)'
  },
  durum: { bekliyor: 'Pending', kabul: 'Accepted', red: 'Declined' },
  ayarlar: {
    baslik: 'Settings',
    hesap: 'Account',
    hakkinda: 'About',
